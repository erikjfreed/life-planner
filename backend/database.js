...
if (entityCount.cnt === 0) {
  ...
  db.transaction(() => {
    ...
    insertEvent.run({ type: 'spouse_death',    year: 2041, month: 12, age: 85, entity_id: erikSpouseResult.lastInsertRowid, name: 'Erik', purchase_price: null, down_payment: null, principal_balance: null, monthly_payment: null,  sale_price: null, selling_costs_pct: null, hidden: 0 });
    insertEvent.run({ type: 'spouse_death',    year: 2048, month: 10, age: 87, entity_id: debSpouseResult.lastInsertRowid,  name: 'Deb',  purchase_price: null, down_payment: null, principal_balance: null, monthly_payment: null,  sale_price: null, selling_costs_pct: null, hidden: 0 });
    ...
    const erikNextResult = insertEntity.run({ type: 'vehicle', name: "Erik's Next Vehicle", street_address: 'Erik', appreciation_rate: -0.075, services_json: vehicleServices, tax_yearly: null, insurance_yearly: null, tax_rate: null, mortgage_rate: null, term_years: null });
    const debNextResult = insertEntity.run({ type: 'vehicle', name: "Deb's Next Vehicle", street_address: 'Deb', appreciation_rate: -0.075, services_json: vehicleServices, tax_yearly: null, insurance_yearly: null, tax_rate: null, mortgage_rate: null, term_years: null });
