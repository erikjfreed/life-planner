    ...
    <div style={styles.container}>
      ...
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={data} margin={{ top: 4, right: 20, left: 10, bottom: 0 }}>
          ...
          <Area type="stepBefore" dataKey="SS"        stackId="1" stroke="#2563eb" fill="#2563eb" fillOpacity={0.6} />
          <Area type="stepBefore" dataKey="ROI"   stackId="1" stroke="#16a34a" fill="#16a34a" fillOpacity={0.6} />
          <Area type="stepBefore" dataKey="Cap Spend" stackId="1" stroke="#dc2626" fill="#dc2626" fillOpacity={0.7} />
        </AreaChart>
      </ResponsiveContainer>
    </div>
  );
