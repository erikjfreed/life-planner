    ...
    <div style={styles.container}>
      ...
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={data} margin={{ top: 4, right: 20, left: 10, bottom: 0 }}>
          ...
          <Area type="linear" dataKey="ROI"       stackId="1" stroke="none" fill="#16a34a" fillOpacity={0.6} />
          <Area type="linear" dataKey="SS"        stackId="1" stroke="none" fill="#2563eb" fillOpacity={0.6} />
          <Area type="linear" dataKey="Cap Spend" stackId="1" stroke="none" fill="#dc2626" fillOpacity={0.7} />
        </AreaChart>
      </ResponsiveContainer>
    </div>
  );
