...
const styles = {
  ...
  subtabs: { display: 'flex', gap: 6, marginTop: 12, marginBottom: 8 },
  ...
  select: { fontSize: 12, fontWeight: 600, border: '1px solid #475569', borderRadius: 3, padding: '0 2px', background: '#1e293b', color: '#e2e8f0' },
};
