...
const styles = {
  ...
  note: { fontSize: 12, color: '#94a3b8', margin: '0 0 16px' },
  ...
  scenarioLabel: { fontSize: 12, color: '#cbd5e1', display: 'block', marginBottom: 8 },
  scenarioControls: { display: 'flex', alignItems: 'center', gap: 12 },
  select: { fontSize: 12, padding: '2px 4px', border: '1px solid #475569', borderRadius: 3, background: '#1e293b', color: '#e2e8f0' },
